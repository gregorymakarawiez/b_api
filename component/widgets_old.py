...
class PortEditorWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None):    
        ...
        <script type="text/javascript" charset="utf-8">  
         ...
         %(name)s_port_name_onblur=function(event){
          ...
          %(name)s_port_description_onblur=function(event){
          ...
          %(name)s_port_default_onblur=function(event){
            ...
            // 4.2 - define jstree settings
                        ...
                        "String": {
                          ...
                          "action": function(obj){
                            ...
                            default_string_data={
                             ...
                             %(name)s.set_nodes_data(%(name)s.hidden_text_DOM, newNode_id,"_all", default_string_data);
                        ...
                        "Float": {
                          ...
                          "action": function(obj){
                            ...
                            default_float_data={
                             ...
                             %(name)s.set_nodes_data(%(name)s.hidden_text_DOM, newNode_id,"_all", default_float_data);
             ...
             $("#%(name)s_jstree").bind('select_node.jstree', function(evt, data){
               ...
               switch(node.type){
                 ...
                 case "category":   
                   var port_form_html_tmpl=$.templates('#%(name)s_category_port_form_html_tmpl');
                   break;
                 case "string":   
                   var port_form_html_tmpl=$.templates('#%(name)s_string_port_form_html_tmpl');
                   break;
                 case "float":   
                   var port_form_html_tmpl=$.templates('#%(name)s_float_port_form_html_tmpl');
                   break;
                 default: 
                   var port_form_html_tmpl=$.templates('#%(name)s_else_port_form_html_tmpl');
               }
        ...
        <script id="%(name)s_category_port_form_html_tmpl" type="text/x-jsrender">
        ...
        <script id="%(name)s_string_port_form_html_tmpl" type="text/x-jsrender">
          <div class='panel panel-primary'> 
            <div class='panel-heading'> 
              {{:type}} port 
            </div> 
        ...
        <script id="%(name)s_float_port_form_html_tmpl" type="text/x-jsrender">
          <div class='panel panel-primary'> 
            <div class='panel-heading'> 
              {{:type}} port 
            </div> 
        ...
        <script id="%(name)s_else_port_form_html_tmpl" type="text/x-jsrender">
          <!--<div class='panel panel-primary'> 
            <div class='panel-heading'> 
              ({{:type}}) port
            </div> 
